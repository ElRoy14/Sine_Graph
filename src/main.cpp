...
bool init()
{
    ...
    while(x < 57.25*pi/180)
    {
        std::cout << "x = " << x << std::endl;
        std::cout << "sin(x) = " << sin(x) << std::endl;
        counter ++;
        vertices[i] = x;
        vertices[i + 1] = sin(15*x);
        vertices[i + 2] = 0.0;  
        vertices[i + 3] = x < 0 ? 1.0 : 0.0;  
        vertices[i + 4] = 0.0; 
        vertices[i + 5] = x > 0 ? 1.0 : 0.0;   
        i += 6;
        x += 0.01;
        ...
        std::cout << aux <<  " vertices= " << i << std::endl;
        aux ++;
